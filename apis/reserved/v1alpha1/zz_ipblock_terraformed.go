...
func (tr *IpBlock) GetObservation() (map[string]interface{}, error) {
...
func (tr *IpBlock) SetObservation(obs map[string]interface{}) error {
...
func (tr *IpBlock) GetParameters() (map[string]interface{}, error) {
...
func (tr *IpBlock) SetParameters(params map[string]interface{}) error {
